function digest = step5b_file_sha256(path)
%STEP5B_FILE_SHA256 Return an uppercase SHA-256 digest for one file.

fileId = fopen(path,'rb');
if fileId < 0
    error('Phase1C:Step5BHash','Unable to open %s.',path);
end
